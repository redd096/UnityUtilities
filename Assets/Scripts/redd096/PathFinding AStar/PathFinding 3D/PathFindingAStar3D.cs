...
namespace redd096
{
    ...
    public class PathFindingAStar3D : MonoBehaviour
    {
        ...
        /// <returns></returns>
        public List<Node3D> FindPath(Vector3 startPosition, Vector3 targetPosition, bool returnNearestPointToTarget = true)
        {
            /*
            ...
            while (openList.Count > 0)
            {
                ...
                */
                ...
                //Current = node in OPEN with the lowest F cost
                //remove Current from OPEN and add to CLOSED
                Node3D currentNode = openList.RemoveFirst();                //all optimized with heap
                closedList.Add(currentNode);
