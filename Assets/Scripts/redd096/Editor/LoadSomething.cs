namespace redd096
{
	...
	public class LoadSomething
	{
		...
		static string pathAssets = "ScriptableObjects/ScriptablesToUpdate";

		[MenuItem("redd096/Load Something")]
		static void Load()
		{
		...
		static void UpdateAsset(string[] value, ClassValues asset)
		{
			...
			asset.typeClass = StringToEnum(value[4]);
		}

		static ETypeClass StringToEnum(string value)
		{
			//remove spaces
			value = value.Replace(" ", "");
