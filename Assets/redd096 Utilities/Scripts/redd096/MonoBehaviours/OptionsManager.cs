...
namespace redd096
{
    ...
    public class OptionsManager : MonoBehaviour
    {
        ...
        public void OnSetVolumeMaster(float value)
        {
            //save
            masterVolume = value;
            SaveManager.SetFloat(fileName, "masterVolume", value);
        ...
        public void OnSetVolumeMusic(float value)
        {
            //save
            musicVolume = value;
            SaveManager.SetFloat(fileName, "musicVolume", value);
        ...
        public void OnSetVolumeSFX(float value)
        {
            //save
            sfxVolume = value;
            SaveManager.SetFloat(fileName, "sfxVolume", value);
        ...
        public void OnSetFullScreen(bool value)
        {
            ...
            SaveManager.SetBool(fileName, "fullScreenEnabled", value);
