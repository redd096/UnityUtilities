...
namespace redd096.FlowField3DPathFinding
{
    ...
    public class GridDebug : MonoBehaviour
    {
        ...
        private GridFlowField3D curFlowField;
        ...
        public void SetFlowField(GridFlowField3D newFlowField)
        {
            curFlowField = newFlowField;
            cellRadius = newFlowField.NodeRadius;
        ...
        private void DisplayAllCells()
        {
            ...
            foreach (Node3D curCell in curFlowField.grid)
            {
                DisplayCell(curCell);
            }
        }
        ...
        private void DisplayCell(Node3D cell)
        {
