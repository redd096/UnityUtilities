...
//https://github.com/emrecelik95/LightScrollSnap
//update from repository 2022/12/22 16:38
...
namespace redd096.UIControl
{
    ...
    public class ScrollSnap : MonoBehaviour
    {
        ...
        [SerializeField] private bool invertScrollValue = false;
        ...
        public ScrollRect ScrollRect => _scrollRect == null ? GetComponent<ScrollRect>() : _scrollRect;
        ...
        private void SetupItems()
        {
            ...
            for (int i = 0; i < _itemCount; i++)
            {
                ...
                _posses[i] = _distance * (invertScrollValue ? _itemCount -1 - i : i);
            }
        ...
        private int GetNearestIndex()
        {
            ...
            {
                var pos = _posses[i];
                if (System.Math.Abs(_scrollPos - pos) <= _distance / 2)
                    return i;
            }
        ...
        {
            if (_items != null && IsIndexInRange(itemIndex))
        ...
        public void AddItemClickListener(int itemIndex, System.Action clickListener)
        {
            if (IsIndexInRange(itemIndex))
                _itemClickHandlers[itemIndex].AddClickListener(clickListener);
        }

        public void RemoveItemClickListener(int itemIndex, System.Action clickListener)
        {
            if (IsIndexInRange(itemIndex))
