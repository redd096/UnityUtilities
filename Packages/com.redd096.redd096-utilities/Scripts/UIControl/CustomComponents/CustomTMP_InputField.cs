...
namespace redd096.UIControl
{
    ...
    /// <summary>
    ///   Custom Editor for the CustomTMP_InputField Component.
    ///   Extend this class to write a custom editor for a component derived from CustomTMP_InputField.
    /// </summary>
    [CanEditMultipleObjects]
    [CustomEditor(typeof(CustomTMP_InputField), true)]
    public class CustomTMP_InputFieldEditor : TMP_InputFieldEditor
    {
    ...
    /// </summary>
    [CustomPropertyDrawer(typeof(CustomTMP_InputField.FCustomTargetGraphics), true)]
    public class CustomTMP_InputFieldTargetGraphicsEditor : PropertyDrawer
    {
