...
{
    /// <summary>
    /// Use this instead of set SortOrder or OrderInLayer in inspector, to get it from data and keep order in the project
    /// </summary>
    [System.Serializable]
    public class SortOrderClass
    {
        ...
        /// Get element
        /// </summary>
        public SortOrderData.Element Element => GetElement(showErrors: true);

        //public
        public int SortingLayer => Element.SortingLayer;
        public int OrderInLayer => Element.OrderInLayer;
        public int SortOrder => Element.OrderInLayer;
        ...
        private SortOrderData.Element GetElement(bool showErrors)
        {
