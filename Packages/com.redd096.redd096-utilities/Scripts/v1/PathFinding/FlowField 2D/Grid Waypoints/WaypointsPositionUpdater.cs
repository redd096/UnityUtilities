...
namespace redd096.v1.PathFinding.FlowField2D
{
    ...
    /// </summary>
    [AddComponentMenu("redd096/v1/PathFinding/FlowField 2D/Grid Waypoints/Waypoints Position Updater 2D")]
    public class WaypointsPositionUpdater : MonoBehaviour
    {
        ...
        Dictionary<WaypointFlowField, Vector2> positions = new Dictionary<WaypointFlowField, Vector2>();
        ...
        void Update()
        {
            ...
            {
                //if moved
                if (waypoint && (Vector2)waypoint.transform.position != positions[waypoint])
                {
