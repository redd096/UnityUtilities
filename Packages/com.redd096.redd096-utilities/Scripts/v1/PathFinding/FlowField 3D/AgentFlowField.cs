...
namespace redd096.v1.PathFinding.FlowField3D
{
    /// <summary>
    /// Used to find path using a PathFindingFlowField and to know if still processing it
    /// </summary>
    [AddComponentMenu("redd096/v1/PathFinding/FlowField 3D/Agent FlowField 3D")]
    public class AgentFlowField : MonoBehaviour
    {
        ...
        public void FindPath(Vector3[] positions, System.Action onEndProcessingPath = null)
        {
        ...
        public void FindPath(Vector3 position, System.Action onEndProcessingPath = null)
        {
